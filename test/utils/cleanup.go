...
// if your test is interrupted (with ctrl+c for example).

// Source: https://github.com/knative/serving/blob/main/test/cleanup.go
// This code is necessary b/c code registered with t.Cleanup are not run when tests are interrupted
// (relevant issue: https://github.com/golang/go/issues/41891)
